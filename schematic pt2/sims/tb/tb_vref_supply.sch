...
value=".control
dc v1 0 6 0.01
write tb_vref_supply.raw v(o07) v(o20) v(o30) v(vdd)
.endc"}
C {devices/launcher.sym} -600 -260 0 0 {name=h1
descr="ctrl-click: load / unload tb_vref_supply.raw"
tclcommand="xschem raw_read $netlist_dir/tb_vref_supply.raw"}
...
vdd;vdd"
x1=0.0
x2=5.9999999999999165
y1=-0.359999999999995
y2=6.3599999999999115}
