...
write tb_beta_mult_supply.raw iref
.endc"}
C {devices/launcher.sym} -600 -260 0 0 {name=h1
descr="ctrl-click: load / unload tb_beta_mult_supply.raw"
tclcommand="xschem raw_read $netlist_dir/tb_beta_mult_supply.raw"}
...
y1=-1.2682293358585919
y2=22.40538493350179}
